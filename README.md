...
A Minecraft Fabric mod that displays floating timers above breedable animals, showing when they can breed again and how long baby animals take to grow up.
...
Download the latest release from [Modrinth](https://modrinth.com/mod/breed-timer) or [GitHub Releases](https://github.com/DennisTheGamer/breed-timer/releases).

## Installation

1. Install [Fabric Loader](https://fabricmc.net/use/)
2. Download [Fabric API](https://modrinth.com/mod/fabric-api)
3. Download BreedTimer (this mod)
