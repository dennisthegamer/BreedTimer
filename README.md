...
Download the latest release from [Modrinth](https://modrinth.com/mod/breedtimer) or [GitHub Releases](https://github.com/DennisTheGamer/BreedTimer/releases). Each release contains one JAR per mod loader (`breedtimer-fabric-1.5.1+mc1.21.6-1.21.8.jar` and `breedtimer-neoforge-1.5.1+mc1.21.6-1.21.8.jar`).
