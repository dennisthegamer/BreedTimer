...
public class BreedTimerHud {
    ...
    public static void render(GuiGraphics graphics, DeltaTracker tickCounter) {
        ...
        if (config.showAnimals) {
            ...
            graphics.drawString(mc.font, animalText, x, currentY, 0xFFFFFFFF, true);
            ...
            if (totalEggs > 0) {
                ...
                graphics.drawString(mc.font, eggText, x, currentY, 0xFFFFFFFF, true);
                currentY += mc.font.lineHeight + 4;
            }
        }
        ...
        if (config.showVillagers && !villagers.isEmpty()) {
            ...
            graphics.drawString(mc.font, villagerText, x, currentY, 0xFFFFFFFF, true);
        }
    }
}
