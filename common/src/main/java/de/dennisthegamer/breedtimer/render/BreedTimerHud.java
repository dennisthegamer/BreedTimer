...
public class BreedTimerHud {
    ...
    public static void render(GuiGraphics graphics, DeltaTracker tickCounter) {
        ...
        // tadpoles the babies count is the only thing they can contribute -- dolphins do not breed.
        // One AgeableMob query rather than a Dolphin-only one: EntityTypeTest.forClass has no
        // index, so a Dolphin.class query would walk exactly the same sections for the same
        // per-entity instanceof, at no saving.
