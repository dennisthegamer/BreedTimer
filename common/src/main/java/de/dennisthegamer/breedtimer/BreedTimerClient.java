...
public final class BreedTimerClient {
     ...
     * every other branch except mc26.2. 26.2 split {@code Gui} into {@code Gui}/{@code Hud}, moving
     * {@code setOverlayMessage} onto the {@code Hud} accessor ({@code mc.gui.hud.setOverlayMessage});
     * on mc26.1 and all four 1.21.x branches, {@code Gui} still has the method directly.
     */
    private static void announce(Minecraft mc, String key) {
        // PORT WARNING (Task 45): this branch calls mc.gui.setOverlayMessage(...) directly, no .hud.
        // Only mc26.2 goes through mc.gui.hud.setOverlayMessage.
