...
public final class BreedTimerClient {
     ...
     * {@code Gui} itself has no {@code setOverlayMessage}. This branch (and every other one except
     * mc26.2) calls {@code mc.gui.setOverlayMessage(...)} directly, with no {@code .hud}.
     */
