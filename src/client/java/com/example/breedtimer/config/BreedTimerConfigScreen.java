...
public class BreedTimerConfigScreen {
    ...
    public static Screen createConfigScreen(Screen parent) {
        return YetAnotherConfigLib.create(BreedTimerConfig.HANDLER, (defaults, config, builder) ->
                builder
                        .title(Text.translatable("breedtimer.config.title"))

                        // Tab 1: General
                        .category(ConfigCategory.createBuilder()
                                .name(Text.translatable("breedtimer.config.category.general"))
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("breedtimer.config.enabled"))
                                        .description(val -> dev.isxander.yacl3.api.OptionDescription.of(
                                                Text.translatable("breedtimer.config.enabled.desc")))
                                        .binding(defaults.enabled, () -> config.enabled, v -> config.enabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("breedtimer.config.showAnimals"))
                                        .description(val -> dev.isxander.yacl3.api.OptionDescription.of(
                                                Text.translatable("breedtimer.config.showAnimals.desc")))
                                        .binding(defaults.showAnimals, () -> config.showAnimals, v -> config.showAnimals = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("breedtimer.config.showVillagers"))
                                        .description(val -> dev.isxander.yacl3.api.OptionDescription.of(
                                                Text.translatable("breedtimer.config.showVillagers.desc")))
                                        .binding(defaults.showVillagers, () -> config.showVillagers, v -> config.showVillagers = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("breedtimer.config.showBabyTimer"))
                                        .binding(defaults.showBabyTimer, () -> config.showBabyTimer, v -> config.showBabyTimer = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("breedtimer.config.compactMode"))
                        ...
                        // Tab 2: Rendering
                        .category(ConfigCategory.createBuilder()
                                .name(Text.translatable("breedtimer.config.category.rendering"))
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("breedtimer.config.scanRadius"))
                                        .description(val -> dev.isxander.yacl3.api.OptionDescription.of(
                                                Text.translatable("breedtimer.config.scanRadius.desc")))
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("breedtimer.config.fadeStartDistance"))
                                        .binding(defaults.fadeStartDistance, () -> config.fadeStartDistance, v -> config.fadeStartDistance = v)
                                        .controller(opt -> IntegerSliderControllerBuilder.create(opt).range(4, 32).step(1))
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("breedtimer.config.fadeEndDistance"))
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("breedtimer.config.fovAngle"))
                                ...
                                .option(Option.<Float>createBuilder()
                                        .name(Text.translatable("breedtimer.config.backgroundOpacity"))
                        ...
                        // Tab 3: Notifications
                        .category(ConfigCategory.createBuilder()
                                .name(Text.translatable("breedtimer.config.category.notifications"))
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("breedtimer.config.playSound"))
