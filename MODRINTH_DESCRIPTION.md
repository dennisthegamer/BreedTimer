...
- **Dried ghasts** — Ripens through hydration stages while waterlogged: "Dried Ghast" → "Soaking" → "Ready to hatch!"
...
All breedable animals in MC 1.21.6–1.21.8 are covered:
...
`mc26.2` and `mc1.21.11` only; dolphin is not on `mc1.21-1.21.1`; bucket ages are not on
`mc1.21.2-1.21.5`; dried ghast and happy ghast are 1.21.6 and up, so this build has both. See the
